<template>
	<div id="app">
		...
		<button class="btn btn-outline-success btn-lg" v-quando:click="acao">Executar</button>
		<p
...
export default {
	...
	methods: {
		acao() {
			alert('Ação acao() Executada!')
		},
		mouseEnter() {
			console.log('Ação MouseEnter Executada')
		},
		mouseLeave() {
			console.log('Ação MOUSE LEAVE Executada')
		}
	}
}
</script>
