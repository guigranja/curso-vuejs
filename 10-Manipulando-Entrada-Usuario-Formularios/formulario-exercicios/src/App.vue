		...
		<div class="conteudo">
			<form class="painel" v-if="!enviado">
				...
				<Rotulo nome="Mensagem">
					<textarea name="" cols="30" rows="5" v-model="usuario.mensagem" placeholder="Inserir o sua mensagem"></textarea>
				</Rotulo>
				...
				<hr>
				<button class="btn btn-outline-primary" @click.prevent="enviar">Enviar</button>
			</form>
